    ...
    <main className="game-shell">
      ...
      <section className="main-board">
        ...
        <TeamPanel
          ...
          score={state.scores.A}

          strikes={state.strikes.A}

          active={
            state.currentTeam === 'A' ||
            state.decisionTeam === 'A' ||
            state.stealingTeam === 'A'
          }
        />
        ...
        <TeamPanel
          ...
          score={state.scores.B}

          strikes={state.strikes.B}

          active={
            state.currentTeam === 'B' ||
            state.decisionTeam === 'B' ||
            state.stealingTeam === 'B'
          }
        />
